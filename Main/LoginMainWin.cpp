...
void CLoginMainWin::LoadImages()
{
	...
	LoadBitmapA("Custom\\Desig\\register_back.tga", 73618, GL_LINEAR, GL_CLAMP, 1, 0);
	LoadBitmapA("Custom\\Desig\\newui_btn_empty_very_small.tga", 71619, GL_LINEAR, GL_CLAMP, 1, 0);
