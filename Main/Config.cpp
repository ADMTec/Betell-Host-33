...
void cConfig::Load()
{
	...
	GetPrivateProfileStringA("ServerNewsTextLine", "TextNews34", "TextNews34", NewsText34, sizeof(NewsText34), CONFIG_FILE);
	GetPrivateProfileStringA("ServerNewsTextLine", "TextNews35", "TextNews35", NewsText35, sizeof(NewsText35), CONFIG_FILE);
	...
	ColorText34_R = GetPrivateProfileIntA("ServerNewsTextColor", "TextColor34_R", 255, CONFIG_FILE);
	ColorText34_G = GetPrivateProfileIntA("ServerNewsTextColor", "TextColor34_G", 255, CONFIG_FILE);
	ColorText34_B = GetPrivateProfileIntA("ServerNewsTextColor", "TextColor34_B", 255, CONFIG_FILE);
	ColorText35_R = GetPrivateProfileIntA("ServerNewsTextColor", "TextColor35_R", 255, CONFIG_FILE);
	ColorText35_G = GetPrivateProfileIntA("ServerNewsTextColor", "TextColor35_G", 255, CONFIG_FILE);
	ColorText35_B = GetPrivateProfileIntA("ServerNewsTextColor", "TextColor35_B", 255, CONFIG_FILE);
