...
void LoginScreen1(int a1, DWORD* a2)
{
...
void RenderSSCObjectVisual1(int a1, int a2)
{
	vec3_t Bone;
	vec3_t Color;
	vec3_t WorldPos;
...
__declspec(naked) void SwitchCharacterView1()
{
...
__declspec(naked) void GameProcessView1()
{
...
DWORD PlayerID1_Offset = 0x005DB532;
void __declspec(naked) PlayerID1()
{
	_asm
	{
...
void SCharacterS8()
{
	...
	SetCompleteHook(0xE8, 0x004D76FB, &LoginScreen1);//Select Server
	SetCompleteHook(0xE8, 0x004D79C3, &LoginScreen1);//Select Server
	SetCompleteHook(0xE8, 0x004D712A, &LoginScreen1);//Select Character
	...
	SetCompleteHook(0xE8, 0x005EDDA9, &RenderSSCObjectVisual1);

	SetOp((LPVOID)0x004D87C8, (LPVOID)SwitchCharacterView1, ASM::JMP);
	SetOp((LPVOID)0x004D87FC, (LPVOID)GameProcessView1, ASM::JMP);
	SetOp((LPVOID)0x005DB52B, (LPVOID)PlayerID1, ASM::JMP);

	SetCompleteHook(0xE8, 0x004D7EB1, &RenderInfomation1);
	//---------
