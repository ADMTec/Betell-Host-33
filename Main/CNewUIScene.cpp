...
*/
__declspec(naked) void SelectPjCord01()
{
...
__declspec(naked) void SelectPjCord02()
{
	static float D41DCC = 13629.000f; //8008.000
...
void CScene()
{
	...
	SetDword((LPVOID)0x004D6C2C, 59);//Select Character
	...
	SetOp((LPVOID)0x0063D1CE, (LPVOID)SelectPjCord01, ASM::JMP);
	SetRange((LPVOID)0x0063D40F, 5, ASM::NOP);
	SetOp((LPVOID)0x0063D40F, (LPVOID)SelectPjCord02, ASM::JMP);
}