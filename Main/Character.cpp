...
void cCharacter::DrawTarget(float x, float y, float w, float h)
{
	if (*(int*)0xE61730 != 65535)
	{
		int c = ((int(__thiscall*)(int a1, int a2)) 0x0096A4C0)(((int(*)()) 0x402BC0)(), *(int*)0xE61730);
		if (c) {
			int o = c + 776;
			float Backup[10] = { 0, };
			...
			*(float *)(o + 260) = -300;
			...
			character.Draw(c, x, y, w, h, *(float *)(o + 272), size);
...
int  cCharacter::ClientChar(int Key)
{
	if (Key < 0)
		return 0;
	return ((int(__thiscall*)(int a1, int Key)) 0x0096A4C0)(((int(*)()) 0x402BC0)(), Key);
}
...
bool cCharacter::Rotate(float x, float y, float w, float h, float *rot, float speed, float defaultRot)
{
	...
	if (!gInterface.IsWorkZone3(x, y, w, h, false)) {
		this->Zoomming = false;
		return ret;
	}
	this->Zoomming = true;
...
void cCharacter::DrawMonster(float x, float y, float w, float h)
{
	int key = ((int(__cdecl*)(int)) 0x57D9A0)(CustomObjectID::oMonster1);
	if (key == 400) //chua co object
	{
		//khoi tao
		this->CreateMonster(CustomObjectID::oMonster1, 727);
	}
	else //da co, ve thoi
	{
		int c = ((int(__thiscall*)(int a1, int a2)) 0x0096A4C0)(((int(*)()) 0x402BC0)(), key);
		...
		{
			int o = c + 776;
			this->Draw2(c, x, y, w, h, 90.f, 1.f);
		}
	}
}

void cCharacter::DrawMonster(float x, float y, float w, float h, int skin)
{
	int key = ((int(__cdecl*)(int)) 0x57D9A0)(CustomObjectID::oMonster2);
	if (key == 400) //chua co object
	{
		//khoi tao
		this->CreateMonster(CustomObjectID::oMonster2, skin);
	}
	else //da co, ve thoi
	{
		int c = ((int(__thiscall*)(int a1, int a2)) 0x0096A4C0)(((int(*)()) 0x402BC0)(), key);
