...
cQuestSystem::cQuestSystem()
{
	...
	//this->InfoColor = 255;
	//this->InfoStartY = 350;	//13
	//this->InfoWidth	 = 80;
	//this->InfoHigh	 = 75;	
	//this->InfoStartX = 555;	//50
	//this->DrawInfoTable = true;


	//this->InfoColor2 = 255;
	//this->InfoStartY2 = 225;
	//this->InfoWidth2	 = 80;
	//this->InfoHigh2	 = 120;	
	//this->InfoStartX2 = 555;
	//this->DrawInfoTable2 = true;

	this->InfoColor = 255;
	this->InfoStartY = 23;	//13
	this->InfoWidth	 = 80;
	this->InfoHigh	 = 75;	
	this->InfoStartX = 90;	//50
	this->DrawInfoTable = true;
...
{
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\NewTable.tga", 100000, 0x2601, 0x2900, 1);

	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B1On.tga", 100001, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B2On.tga", 100002, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B3On.tga", 100003, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B4On.tga", 100004, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B5On.tga", 100005, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B6On.tga", 100006, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B7On.tga", 100007, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B8On.tga", 100008, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B9On.tga", 100009, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B10On.tga", 100010, 0x2601, 0x2900, 1);

	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B1Off.tga", 100011, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B2Off.tga", 100012, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B3Off.tga", 100013, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B4Off.tga", 100014, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B5Off.tga", 100015, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B6Off.tga", 100016, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B7Off.tga", 100017, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B8Off.tga", 100018, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B9Off.tga", 100019, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\B10Off.tga", 100020, 0x2601, 0x2900, 1);

	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\AcceptOn.tga", 100021, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\AcceptOff.tga", 100022, 0x2601, 0x2900, 1);

	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\RewardOn.tga", 100023, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\RewardOff.tga", 100024, 0x2601, 0x2900, 1);

	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\Color.tga", 100025, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\Left.tga", 100026, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\Right.tga", 100027, 0x2601, 0x2900, 1);

	gInterface.LoadImages("ExTeam\\QuestSystem\\Border\\wing1.tga", 100028, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Border\\wing2.tga", 100029, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ExTeam\\QuestSystem\\Border\\reward.tga", 100030, 0x2601, 0x2900, 1);	//Reward
	gInterface.LoadImages("ExTeam\\QuestSystem\\Border\\price.tga", 100031, 0x2601, 0x2900, 1);		//Price
	gInterface.LoadImages("ExTeam\\QuestSystem\\Border\\drop.tga", 100032, 0x2601, 0x2900, 1);		//Drop
	gInterface.LoadImages("ExTeam\\QuestSystem\\Border\\kill.tga", 100033, 0x2601, 0x2900, 1);		//kill
	gInterface.LoadImages("ExTeam\\QuestSystem\\Border\\info.tga", 100034, 0x2601, 0x2900, 1);		//Info Border
	gInterface.LoadImages("ExTeam\\QuestSystem\\Border\\need.tga", 100035, 0x2601, 0x2900, 1);

	gInterface.LoadImages("ExTeam\\QuestSystem\\Buttons\\Close.tga", 100036, 0x2601, 0x2900, 1);
}
...
void cQuestSystem::MouseRun()
{
	...
	if(gController.wMouse == WM_MOUSEMOVE && MoveAct == true && this->DrawInfoTable)
	{
		...
		{
			pSetCursorFocus = true;
			//InfoStartY = pCursorY-5;
			//InfoStartX = pCursorX - InfoWidth/2;
		}
	}
	...
	if(gController.wMouse == WM_MOUSEMOVE && MoveAct2 == true && this->DrawInfoTable2)
	{
		...
		{
			pSetCursorFocus = true;
			//InfoStartY2 = pCursorY-5;
			//InfoStartX2 = pCursorX - InfoWidth2/2;
		}
	}
}
...
void cQuestSystem::LoadGame()
{
	...
	while (!feof(file))
	{
		...
		//sscanf(Buff, QUESTBUFFER, 
		//	&this->InfoColor, &this->InfoStartY, &this->InfoWidth,&this->InfoHigh,&this->InfoStartX,&this->DrawInfoTable,
		//	&this->InfoColor2, &this->InfoStartY2, &this->InfoWidth2,&this->InfoHigh2,&this->InfoStartX2,&this->DrawInfoTable2);
