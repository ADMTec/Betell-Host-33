...
#define pCursorXx					*(int*)0x00879340C
#define pCursorYy					*(int*)0x008793410
...
#define pMyFocus					*(DWORD*)0x00E8CB3D
...
#define JCStore						((int(__thiscall*)(int a1)) 0x00841E10)
#define JCInvExt					((void(__thiscall*)(int a1)) 0x007D5570)
