...
void eCustomFont::load() {
	...
	this->FontSize20 = CreateFontA(20, Width, 0, 0, 400, Italic, UnderLine, StrikeOut, 0x1, 0, 0, Quality, 0, "Tahoma");
	this->FontSize25 = CreateFontA(25, Width, 0, 0, 400, Italic, UnderLine, StrikeOut, 0x1, 0, 0, Quality, 0, "Tahoma");
	this->FontSize30 = CreateFontA(30, Width, 0, 0, 400, Italic, UnderLine, StrikeOut, 0x1, 0, 0, Quality, 0, "Tahoma");
}
