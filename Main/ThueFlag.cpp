...
void cThueFlag::Draw()
{
	...
	{
	gInterface.DrawToolTip(x + w - 25, y + 25, "Close");
	}
	...
	CustomFont.Draw(CustomFont.FontBold, x, y + 12, 0xffffffff, 0x0, w, 0, 3, "Flag System");
	...
	if (skin != 0)
	{
		CustomFont.Draw(CustomFont.FontNormal, x, y + 76, 0xffffffff, 0x0, 150, 0, 3, "Precio (WC) : %d", skin->Price);

		CustomFont.Draw(CustomFont.FontNormal, x, y + 101, 0xffffffff, 0x0, 150, 0, 3, "Daño : %d", skin->Value1);
		CustomFont.Draw(CustomFont.FontNormal, x, y + 126, 0xffffffff, 0x0, 150, 0, 3, "Defense : %d", skin->Value2);
		CustomFont.Draw(CustomFont.FontNormal, x, y + 151, 0xffffffff, 0x0, 150, 0, 3, "HP : %d", skin->Value3);
		CustomFont.Draw(CustomFont.FontNormal, x, y + 176, 0xffffffff, 0x0, 150, 0, 3, "MP : %d", skin->Value4);
		...
		if (skin->Skin == abs(this->Skin))
		{
			...
			CustomFont.Draw(CustomFont.FontNormal, x + 4 + 75 * 2, y + 35, 0xffffffff, 0x0, 150, 0, 3, "Custom Flag");

			CustomFont.Draw(CustomFont.FontNormal, x + 14 + 75 * 4, y + h - 62.5, 0xffffffff, 0x0, 73, 0, 3, this->Skin < 0 ? "Usar" : "No Usar");
		}
		else
		{
			CustomFont.Draw(CustomFont.FontNormal, x + 34 + 75 * 2, y + 35, 0x0, 0x00F5FF, 80, 10, 0, " ");
			CustomFont.Draw(CustomFont.FontNormal, x + 4 + 75 * 2, y + 35, 0xffffffff, 0x0, 150, 0, 3, "No Activado");
			CustomFont.Draw(CustomFont.FontNormal, x + 14 + 75 * 4, y + h - 62.5, 0xffffffff, 0x0, 73, 0, 3, "Comprar");
		}
