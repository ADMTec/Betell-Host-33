...
char ChatWindowsDrawClasic(MUChat* This)
{
	...
	{
		if (This->pWindowHeight == 55)
		{
			This->WindowPosY = 95;
		}

		if (This->pWindowHeight == 100)
		{
			This->WindowPosY = 140;
		}

		if (This->pWindowHeight == 145)
		{
			This->WindowPosY = 185;
		}

		if (This->pWindowHeight == 190)
		{
			This->WindowPosY = 235;
		}

		if (This->pWindowHeight == 235)
		{
			This->WindowPosY = 280;
		}
	}
...
char RenderFrameChatClassic(MUChat* This)
{
	...
	if (This->WindowsActivo) {
		...
		v16 = (double)(This->WindowPosY - This->pWindowHeight);
		v9 = This->WindowPosX + This->pWindowWidth - 5;
		v4 = v16 - 5.0;
		pSetBlend(true);
