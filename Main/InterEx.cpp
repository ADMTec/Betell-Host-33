...
//--
	...
	pDrawText(pTextThis(), Return2X( XSDCoord + TransForX( 179.375 ) ), ReturnY(TransForY(429.50)), String, Return2X( Width ), 0, (LPINT)3, 0);
//--
	//-- HP
	ZeroMemory(String, sizeof(String));
...
void BPCurrentLive( )
{
	...
	pDrawText(pTextThis(), Return2X(XBPCoord + TransForX( 395 )), ReturnY(TransForY(429.50)), String, Return2X( Width ), 0, (LPINT)3, 0);
