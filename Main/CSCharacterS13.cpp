...
//-- 4
...

		{
			if (gSelectChar.m_CharacterPage >= 1)
			{
				...
				gInterface.DrawFormat(eGold, 537, 243, 0, 0, "Page: %d", gSelectChar.m_CharacterPage);
				gInterface.DrawButton(eSELECTCHAR_LEFT, 491, 236, 0, 0);
			...
			{
				gInterface.DrawButton(eSELECTCHAR_RIGHT, 575, 236, 0, 0);
...
void CSCharacterS13::SelectCharButton(DWORD Event)
{
	...
	
	{
		...
		if (gInterface.IsWorkZone(eSELECTCHAR_LEFT))
		{
			...
			// ----
			gSelectChar.m_CharacterPage--;
			CGSendMultiChar(gSelectChar.m_CharacterPage);
			((int(__cdecl*)(int Num)) 0x0057D620)(-1);
			*(BYTE*)0xE8CB4E = 0;
			*(DWORD*)(MAIN_SCREEN_STATE) = SwitchCharacter;
			*(DWORD*)0x87935A4 = 50;
