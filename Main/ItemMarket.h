...
public:
	...
	void SwitchResetStatsWindowState() { (gInterface.Data[exWinItemMarket].OnShow == true) ? gInterface.Data[exWinItemMarket].Close() : gInterface.Data[exWinItemMarket].Open(); };
