...
public:
	...
	void DrawMonster(float x, float y, float w, float h, int skin);
	void DrawMonster(float x, float y, float w, float h);
	void DrawTarget(float x, float y, float w, float h);
